...
<div id="main_center">
	<h1>添加日志</h1>
  <?php echo form_open('manageroot/product_log/add', array('class' => 'form-horizontal')); ?>
  ...
  <div class="control-group <?php if(!empty(form_error('log_time'))): ?>error<?php endif; ?>">
    <label class="control-label" for="log_time">升级日期</label>
    <div class="controls">
      <input type="text" id="log_time" name="log_time" value="<?php echo set_value('log_time'); ?>" class="input-xxlarge" placeholder="请填写更新日期; 格式：2016-10-20">
  ...
  <div class="control-group <?php if(!empty(form_error('desc'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <textarea rows="5" style="width:528px;" name="desc"></textarea>
    </div>
  </div>
