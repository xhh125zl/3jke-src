...
<div id="main_center">
	<h1>修改公司面貌</h1>
  <?php echo form_open_multipart('manageroot/setting/company_face_edit/'.$single_info['face_id'], array('class' => 'form-horizontal')); ?>
  ...
  <div class="control-group <?php if(!empty(form_error('face_pic'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      ...
      <?php if(!empty($single_info['face_pic'])): ?><img src="<?php echo base_url($single_info['face_pic']); ?>" width="60px" height="30px"><?php endif; ?>
  ...
  <div class="control-group <?php if(!empty(form_error('face_title'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="text" id="face_title" name="face_title" value="<?php echo $single_info['face_title']; ?>" class="input-xxlarge" placeholder="图片标题">
  ...
  <div class="control-group">
      ...
      <div class="controls">
        <input type="radio" id="face_status" name="face_status" value="1" <?php if($single_info['face_status'] == 1): ?>checked="checked"<?php endif; ?> class="input-xxlarge">启用
        &nbsp;&nbsp;
        <input type="radio" id="face_status" name="face_status" value="0" <?php if($single_info['face_status'] == 0): ?>checked="checked"<?php endif; ?> class="input-xxlarge">停用
      </div>
    </div>
