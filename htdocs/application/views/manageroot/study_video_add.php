...
<div id="main_center">
	<h1>添加教育视频</h1>
  <?php echo form_open_multipart('manageroot/study_video/video_add', array('class' => 'form-horizontal')); ?>
    ...
    <div class="control-group <?php if(!empty(form_error('video_name'))): ?>error<?php endif; ?>">
      ...
      <div class="controls">
        <input type="text" id="video_name" name="video_name" class="input-xxlarge" placeholder="视频名称">
        ...
        <select id="catgory_id" name="catgory_id">
          <?php if(!empty($catgory_list)): ?>
            <?php foreach($catgory_list as $k => $v): ?>
              <option value="<?php echo $v['catgory_id']; ?>"><?php echo $v['catgory_name']; ?></option>
            <?php endforeach; ?>
          <?php endif; ?>
        </select>
      </div>
    ...
    <!-- <div class="control-group <?php if(!empty(form_error('video_keyword'))): ?>error<?php endif; ?>">
      ...
      <div class="controls">
        <input type="text" id="video_keyword" name="video_keyword" class="input-xxlarge" placeholder="关键字">
    ...
    <div class="control-group <?php if(!empty(form_error('video_href'))): ?>error<?php endif; ?>">
      ...
      <div class="controls">
        <input type="text" id="video_href" name="video_href" class="input-xxlarge" placeholder="视频链接  格式：http://player.youku.com/embed/XMjY3MzgzODg0">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="radio" id="video_status" name="video_status" value="1" checked="checked" class="input-xxlarge">启用
        &nbsp;&nbsp;
        <input type="radio" id="video_status" name="video_status" value="0" class="input-xxlarge">停用
      </div>
    </div>
