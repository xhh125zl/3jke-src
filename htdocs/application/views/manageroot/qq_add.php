...
<div id="main_center">
	<h1>添加客服</h1>
  <?php echo form_open('manageroot/setting/qq_add', array('class' => 'form-horizontal')); ?>
  ...
  <div class="control-group <?php if(!empty(form_error('qq_name'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="text" id="qq_name" name="qq_name" value="" class="input-xxlarge" placeholder="">
  ...
  <div class="control-group <?php if(!empty(form_error('qq_code'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="text" id="qq_code" name="qq_code" value="" class="input-xxlarge" placeholder="">
  ...
  <div class="control-group <?php if(!empty(form_error('serve_status'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="radio" id="serve_status" name="serve_status" value="1" checked="checked" class="input-xxlarge">启用
      <input type="radio" id="serve_status" name="serve_status" value="0"  class="input-xxlarge">禁用
    </div>
  </div>
