...
<div id="main_center">
	<h1>编辑感言</h1>
  <?php echo form_open_multipart('manageroot/customer_talk/talk_edit/'.$talk_info['talk_id'], array('class' => 'form-horizontal')); ?>
  ...
  <div class="control-group <?php if(!empty(form_error('user_name'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="text" id="user_name" name="user_name" value="<?php echo $talk_info['user_name']; ?>" class="input-xxlarge" placeholder="感言作者">
  ...
  <div class="control-group <?php if(!empty(form_error('talk_title'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <input type="text" id="talk_title" name="talk_title" value="<?php echo $talk_info['talk_title']; ?>" class="input-xxlarge" placeholder="感言标题">
  ...
  <div class="control-group <?php if(!empty(form_error('talk_content'))): ?>error<?php endif; ?>">
    ...
    <div class="controls">
      <textarea name="talk_content" style="width:700px;height:250px;visibility:hidden;"><?php echo $talk_info['talk_content']; ?></textarea>
    </div>
  </div>
